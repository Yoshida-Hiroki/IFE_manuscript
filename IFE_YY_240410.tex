...
\be
    \frac{a_{zxx}}{k_F^4}&=-\frac{\tilde{k}_y \qty(2 a \tilde{k}_x+1) \left\{3a\qty(a\tilde{k}_x^2+\tilde{k}_x)^2+2\qty(a\tilde{k}_x^2+\tilde{k}_x)-a\qty(\tilde{k}_y^2+\tilde{M}^2)\right\}}{2 \left\{\qty(a\tilde{k}_x^2+\tilde{k}_x)^2+\tilde{k}_y^2+\tilde{M}^2\right\}^3},\\
    \frac{a_{zxy}}{k_F^4}&=\frac{10 a\qty(a\tilde{k}_x^2+\tilde{k}_x)^3+3\qty(a\tilde{k}_x^2+\tilde{k}_x)^2-6a\qty(a\tilde{k}_x^2+\tilde{k}_x)\qty(\tilde{k}_y^2+\tilde{M}^2)-\qty(\tilde{k}_y^2+\tilde{M}^2)}{4 \left\{\qty(a\tilde{k}_x^2+\tilde{k}_x)^2+\tilde{k}_y^2+\tilde{M}^2\right\}^3},\\
    \frac{a_{zyx}}{k_F^4}&=\frac{\left\{2a\qty(a\tilde{k}_x^2+\tilde{k}_x)+1\right\}\left\{\qty(a\tilde{k}_x^2+\tilde{k}_x)^2-3\tilde{k}_y^2+\tilde{M}^2\right\}}{4 \left\{\qty(a\tilde{k}_x^2+\tilde{k}_x)^2+\tilde{k}_y^2+\tilde{M}^2\right\}^3},\\
    \frac{a_{zyy}}{k_F^4}&=\frac{\tilde{k}_x \tilde{k}_y \left\{2a\qty(a\tilde{k}_x^2+\tilde{k}_x)+a\tilde{k}_x+1\right\}}{\left\{\qty(a\tilde{k}_x^2+\tilde{k}_x)^2+\tilde{k}_y^2+\tilde{M}^2\right\}^3},
\ee
